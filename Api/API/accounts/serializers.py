...
class UserRegistrationSerializer(serializers.ModelSerializer):
  ...
  class Meta:
    model = User
    fields=['email', 'username','tc', 'mobile','password', 'password2']
    extra_kwargs={
...
class UserProfileSerializer(serializers.ModelSerializer):
  class Meta:
    model = User
    fields = ['id', 'email', 'mobile','username','password']
    extra_kwargs={
...
class SendPasswordResetEmailSerializer(serializers.Serializer):
  ...
  def validate(self, attrs):
    ...
    if User.objects.filter(email=email).exists():
      ...
      mmm=body
      msg = MIMEText(mmm, 'plain', 'utf-8')
      msg['Subject'] =  Header("Smart Parking", 'utf-8')
      msg['From'] = formataddr((str(Header(sender_title, 'utf-8')), sender))
      msg['To'] = recipient
      # Create server object with SSL option
      server = smtplib.SMTP_SSL('smtp.zoho.com', 465)
      # Perform operations via server
      server.login('support@sstpl.net.in', 'SupporT@SstpL1')
